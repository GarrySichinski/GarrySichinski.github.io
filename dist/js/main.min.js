(function () {
    ...
    Bubble.prototype.randomise = function () {
      ...
      self.velocity = 7 // Скорость левитации пузырька (чем выше, тем медленнее)
      self.smoothFactor = 35 // Коэффициент сглаживания (чем выше, тем плавнее)
      self.staticity = 10 // Увеличение значения замедляет движение пузырьков при перемещении мыши
